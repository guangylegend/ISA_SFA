function isanetwork=isa_est(Z, V,params,layer)
...
if (layer==1) 
    n = params.pca_dim_l1;
    subspacesize = params.group_size_l1;
elseif (layer==2) 
    n = params.pca_dim_l2;
    subspacesize = params.group_size_l2;
end
sp_size = params.fovea{layer}.spatial_size;
 ...
 % end
  ...
  %-------------------------------------------------------------  
    ...
    if mod(iter, 50) == 0
        ...
        isanetwork{1}.temporal_size = tp_size;
        isanetwork{1}.spatial_size = sp_size;        
