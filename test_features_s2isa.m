function [] = test_features_s2isa(params)
...
[Xtrain_raw{1}, MM_train{1}, train_indices{1}] = compute_raw_features_s2isa(params, all_train_files, 1);
normalized(Xtrain_raw{1},MM_train{1});
...
fprintf('Computing features for all videos in the training set:\n');
[Xtest_raw{1}, MM_test{1}, test_indices{1}] = compute_raw_features_s2isa(params, all_test_files, 1);
normalized(Xtest_raw{1},MM_test{1});
